...
include_once('updater.php');
 ...
 if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
 		$config = array(
 			...
 			'proper_folder_name' => 'mcaddons', // this is the name of the folder your plugin lives in
 			'api_url' => 'https://api.github.com/repos/lmoncany/mcaddons', // the GitHub API url of your GitHub repo
 			'raw_url' => 'https://raw.github.com/lmoncany/mcaddons/master', // the GitHub raw url of your GitHub repo
 			'github_url' => 'https://github.com/lmoncany/mcaddons', // the GitHub url of your GitHub repo
 			'zip_url' => 'https://github.com/lmoncany/mcaddons/zipball/master', // the zip url of the GitHub repo
